...
export default async function EditPost({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <form action={async (fd) => { 'use server'; await updatePost(id, fd); }} className="space-y-4">
        <div>
        ...
        <div>
          ...
          <textarea name="content" rows={8} defaultValue={post.content} className="mt-1 w-full rounded border px-3 py-2" required />
        </div>
